...
| **Copilot 项目路径关联** | AI 执行时自动在关联项目的本地目录中工作 |
...
```json
"CopilotCli": {
  "CommandPath": "copilot",             // Copilot CLI 命令路径
  "WorkingDirectory": "C:\\repo",     // 默认工作目录（当卡片未关联项目时使用）
  "TimeoutSeconds": 300                 // 执行超时时间（默认 5 分钟）
}
```
...
- [x] **v1.2 新增**: 后端服务和仓库接口更新
- [x] **v1.2 新增**: 前端卡片详情页面抽离并添加路由配置
- [x] **v1.2 新增**: 仓库文件修改，包括前端Index.vue和多个Repository接口
- [x] **v1.2 新增**: 手动看板管理功能，包括创建、编辑、删除看板，以及搜索、筛选和分页功能
- [x] **v1.2 新增**: 看板接口字段修改
- [x] **v1.2 新增**: 修复对话框样式问题，确保表单元素对齐显示
- [x] **v1.2 新增**: 提交看板前后端对应关系检查需求文档
- [x] **v1.3 新增**: Copilot 项目路径关联 - AI 执行时自动在关联项目的本地目录中工作
- [x] **v1.3 新增**: 前端看板卡片显示项目信息 - 卡片上显示关联项目的名称和本地路径

**当前状态**: v1.3 功能扩展开发完成，编译零错误，可进行测试部署

## 📝 开发文档

- [开发计划](./docs/development-plan.md)
- [需求分析](./docs/01-需求分析.md)
- [后端实现方案](./docs/02-后端实现方案.md)
- [前端实现方案](./docs/03-前端实现方案.md)
- [实施步骤](./docs/04-实施步骤.md)
- [测试计划](./docs/05-测试计划.md)
- [知识沉淀](./docs/06-知识沉淀.md)
- [预期效果](./docs/07-预期效果.md)
- [开发引导](./docs/DEVELOPMENT-GUIDE.md)
- [Vol.Core 开发规范](./docs/volcore-development-guide.md)
- [从看板到AI执行的完整流程](./docs/kanban-to-ai-execution-process.md)
